<?php
	...
	// Required
	if($feide_connect_config === false) {
		Response::error(404, $_SERVER["SERVER_PROTOCOL"] . ' Not Found: Connect config.');
	}
	// Instanciate
	...
	if($relay_config === false) {
		Response::error(404, $_SERVER["SERVER_PROTOCOL"] . ' Not Found: Relay config.');
	}
