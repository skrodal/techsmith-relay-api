...
// ---------------------- DEFINE ROUTES ----------------------
 ...
 /* DONE */ array('GET','/org/[org:orgId]/users/count/affiliation/',         function($orgId){ global $relay; Response::result(array('status' => true, 'data' => $relay->getOrgUserCountByAffiliation($orgId))); }, 						'Total user count at org (Scope: admin/org).'),
